...
6. **Ship or stop.** For changed: one PR of proven corrections via `gh`, re-read every changed file first. For clean or blocked: no PR, report the outcome and the coverage honestly.
