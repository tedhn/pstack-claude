...
"Bugbot" below stands for any automated reviewer: Cursor Bugbot, GitHub Copilot review, CodeRabbit, a security scanner, or a CI bot that comments on PRs. The rubric is the same for all of them.
